...
OE_PORT="8069"
# Choose the Odoo version which you want to install. For example: 16.0, 15.0, 14.0, 13.0, 12.0, 11.0 or saas-18. When using 'master' the master version will be installed.
...
## https://www.odoo.com/documentation/16.0/administration/install.html#debian-ubuntu
...
sudo apt install python3-cffi build-essential wget python3-dev python3-venv python3-wheel libxslt-dev libzip-dev libldap2-dev libsasl2-dev python3-setuptools node-less libpng-dev libjpeg-dev gdebi xfonts-base xfonts-75dpi -y
...
if [ $INSTALL_WKHTMLTOPDF = "True" ]; then
  echo -e "\n---- Install wkhtml and place shortcuts on correct place for ODOO 16 ----"
...
sudo git clone --branch $OE_VERSION https://github.com/odoo/odoo $OE_HOME_EXT/
...
if [ $IS_ENTERPRISE = "True" ]; then
    ...
    GITHUB_RESPONSE=$(sudo git clone --branch $OE_VERSION https://github.com/odoo/enterprise "$OE_HOME/enterprise/addons" 2>&1)
