...
```
wget https://raw.githubusercontent.com/MihranThalhath/InstallScript/16.0/odoo_install.sh
```
...
```OE_VERSION``` is the Odoo version to install, for example ```16.0``` for Odoo 16.<br/>
